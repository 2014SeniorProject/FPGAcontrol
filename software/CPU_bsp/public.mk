...
SOPCINFO_FILE := V:/FPGAcontrol/CPU.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x4011190
SOPC_SYSID_FLAG += --sidp=0x4011190
ELF_PATCH_FLAG  += --sidp 0x4011190

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1391228168
SOPC_SYSID_FLAG += --timestamp=1391228168
ELF_PATCH_FLAG  += --timestamp 1391228168
