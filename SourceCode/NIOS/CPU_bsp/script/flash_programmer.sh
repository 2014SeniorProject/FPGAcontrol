...
#
# Converting ELF File: C:\FPGAcontrol\SourceCode\NIOS\Software\CPU.elf to: "..\flash/CPU_epcs_flash_controller_0.flash"
#
...
#
nios2-flash-programmer "../flash/CPU_epcs_flash_controller_0.flash" --base=0x4011000 --epcs --accept-bad-sysid --device=1 --instance=0 '--cable=USB-Blaster on localhost [USB-0]' --program --verbose 
